...
@Component
public class ValidadorFueraDelHorarioConsultas implements IValidadorDeConsultas{
    public void validar(DatosReservaConsulta datos) {
        ...
        if(domingo || horarioAntesDeAperturaClinica || horarioDespuesDeCierreClinica)
            throw new ValidacionException("No se puede agendar una consulta en el horario seleccionado.");
    }
}
